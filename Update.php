                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-6">
                                <?php
$t_product = $_GET['product_id_no'];

$qury = "SELECT * FROM `tbl_product` WHERE `pid`='$t_product' ";
...
if($data = mysqli_fetch_assoc($run))
  {  ?>
                                    ...
                                    <form role="form" action="Update_2.php" onsubmit="validation()" enctype="multipart/form-data" method="POST" name="Form3">
                                       <div class="form-group">
                                            <label>Product IP :  </label> 
                                             <input class="form-control" style="width: 180%"  type="text" disabled="disabled"   value=<?php echo $data['pid'];?>    >
                                   ...
                                   ?>       
                                       ...
                                       <div class="form-group">
                                            ...
                                            <input class="form-control" style="width: 180%"  type="date" name="Rdate" >
                                         
                                        </div>
                                         <div class="form-group">
                                            <label> Discription : </label>
                                            <textarea class="form-control" style="width: 180%"  type="text" name="dics" >
                                              
                                            </textarea>
                                         
                                        </div>
                                        <div class="form-group">
                                            <label> Upgrade Or Repair Cost : </label>
                                            <input class="form-control" style="width: 180%" type="number" name="cost">
