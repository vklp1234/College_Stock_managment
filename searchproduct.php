    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="searchproduct.php">SISTec - Stock</a> 
            </div>
            <?php 
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <form role="form" action="searchproduct.php" onsubmit="validation()" enctype="multipart/form-data" method="POST" name="Form3">
                           <div class="form-group">
                                            <label>Search by Pid :</label> 
                                            <input class="form-control " style="width: 24%;" type="text" name="Pid" required="required" />
                                         
                                        </div>
                                        <label style="color: brown;">Or</label>
                                          <div class="form-group">
                                            <label> Select Lab/Room No : </label>
                                            <select  name="lno"  id="combo">
                                         ...
                                         <input type="submit" class="btn btn-success" name="serach" value="Search" />
                                ...
                                <table class="table table-striped table-bordered table-hover" >
                                    ...
                                    <tbody>
                                      ...
                                      if(isset($_POST['serach']))
                                      {
                                        $product = $_POST['Pid'];
                                        $lab = $_POST['lno'];
                                        $qury = "SELECT * FROM `tbl_product` WHERE `pid`='$product' or lab_room_no='$lab' ";
                                          ...
                                          while($data = mysqli_fetch_assoc($run))
                                          {
                                            ...
                                            <td class="center"><?php echo $data['product_company'] ?></td>
                                             <td class="center"><?php echo $data['incharge_name'] ?></td>
                                              ...
                                              <td class="center"><a href="Update.php?product_id_no=<?php echo $data['pid'] ; ?>" class="btn btn-success">Click here</a></td>
